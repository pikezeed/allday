...
class Home_controller extends CI_Controller{
	...
	{
		parent::__construct();
		$this->load->helper('my_session_helper'); // load libray session // โหลด libray session
	}

	// call landing page //เรียก home page
	public function index()
	{
		if(	checkIsSession($this->session->userdata('logged_in')) ){	// check session exist // เช็ค ว่ามี session 
